package com.homework.week8.max.product;

import com.aca.homework.week8.max.product.MaxProduct;
...
class MaxProductTest {
    ...
    public void case6Test() {
        int[] case6 = {-1};
        Assertions.assertEquals(-1, MaxProduct.calculateMaxProduct(case6));
    }
}